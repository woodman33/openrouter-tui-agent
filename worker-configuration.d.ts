/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 10af890b9b721cee9fb64b08c2457f67)
// Runtime types generated with workerd@1.20260730.1 2025-10-08 
interface __BaseEnv_Env {
	OPENROUTER_TUI_AGENT_PAYLOAD_R2: R2Bucket;
	"OPENROUTER-TUI-AGENT-D1": D1Database;
	OPENROUTER_TUI_AGENT_VECTORIZE_INDEX: VectorizeIndex;
	OPENROUTER_TUI_AGENT_HYPERDRIVE: Hyperdrive;
	TELEMETRY_ANALYTICS: AnalyticsEngineDataset;
	OPENROUTER_TUI_AGENT_QUEUE: Queue;
	OPENROUTER_TUI_AGENT_WORKERS_AI: Ai;
	OPENROUTER_TUI_AGENT_AISEARCH: "default";
	OPENROUTER_TUI_AGENT_AISEARCH_NOT_NAMESPACE: "autorag-system";
	OPENROUTER_TUI_AGENT_FLAGSHIP: "new-flag-app";
	...
	BREAK_MODE_API_BASE_URL: string;
	DAYTONA_API_KEY: string;
	DAYTONA_SERVER_URL: string;
	DAYTONA_TARGET_PROVIDER: string;
	TRIGGER_SECRET_KEY: string;
	TRIGGER_API_URL: string;
	CLOUDFLARE_GATEWAY_NAME: string;
	COMPOSIO_API_KEY: string;
	COMPOSIO_ORGANIZATION_ACCESS_TOKEN_SECRET: string;
	CLOUDFLARE_FLAGSHIP_APP_ID: string;
	CLOUDFLARE_SECRETS_STORE_ID: string;
	CLOUDFLARE_ACCOUNT_ID: string;
	CLOUDFLARE_API_TOKEN: string;
	CLOUDFLARE_CURL_COMMAND: string;
	CLOUDFLARE_S3_API_TOKEN: string;
	CLOUDFLARE_S3_ID: string;
	CLOUDFLARE_R2_WAREHOUSE_NAME: string;
	CLOUDFLARE_R2_CATALOG_URL: string;
	CLOUDFLARE_SINK_ID: string;
	CLOUDFLARE_SINK_NAME: string;
	...
	AGORA_APP_ID: string;
	AGORA_PROJECT_NAME: string;
	AGORA_PRIMARY_CERTIFICATE: string;
	AGORA_ORGANIZATION_NAME: string;
	AGORA_COMPANY_ID: string;
	AGORA_CUSTOMER_ID: string;
	AGORA_API_KEY: string;
	AGORA_ACCESS_KEY: string;
	ANAM_API_KEY: string;
	VERCEL_AI_GATEWAY: string;
	KENDO_API_KEY: string;
	KENDO_LICENSING_KEY: string;
	MUX_TOKEN_ID: string;
	MUX_API_KEY: string;
	CONTENTFUL_SPACE_ID: string;
	"CONTENTFUL-DELIVERY_TOKEN": string;
	CONTENTFUL_PREVIEW_TOKEN: string;
	CONTENTFUL_PERSONAL_ACCESS_TOKEN: string;
	HEYGEN_AGENT_API: string;
	HEYGEN_DEVELOPER_API: string;
	CLIP_ROXY_API_KEY: string;
	RUNWAYML_API_KEY: string;
	ELEVENLABS_API_KEY: string;
	NOTION_PERSONAL_ACCESS_TOKEN: string;
	TALLY_API_KEY: string;
	AZURE_FOUNDRY_API_KEY: string;
	COMFYDEPLOY_API_KEY: string;
	HYPERSTACK_API_KEY: string;
	GEMINI_API_KEY: string;
	BLACK_FOREST_LABS_API_KEY: string;
	HYPERBOLIC_API_KEY: string;
	"10WEB_API_KEY": string;
	RUNCOMFY_USER_ID: string;
	RUNCOMFY_API_KEY_1: string;
	RUNCOMFY_API_KEY_2: string;
	AGENTQL_API_KEY: string;
	REF_API_KEY: string;
	VENICE_AI_API_KEY: string;
	...
	FLYIO_API_KEY: string;
	CURSOR_API_KEY: string;
	ABACUS_API_KEY_1: string;
	HIGGSFIELD_API_KEY_ID: string;
	HIGGSFIELD_API_KEY: string;
	REVE_API_KEY: string;
	REVE_API_KEY_2: string;
	REVE_IMAGE_CREATE_URL: string;
	REVE_IMAGE_EDIT_URL: string;
	REVE_IMAGE_REMIX_URL: string;
	DECART_API_KEY: string;
	CIVITAI_API_KEY: string;
	CIVITAI_API_KEY_2: string;
	SPARK1_HOSTNAME: string;
	SPARK1_USER: string;
	SPARK1_PASSWORD: string;
	SPARK1_TAILSCALE_IP: string;
	SPARK2_HOSTNAME: string;
	SPARK2_USER: string;
	SPARK2_PASSWORD: string;
	SPARK2_TAILSCALE_IP: string;
	SPARK3_HOSTNAME: string;
	SPARK3_USER: string;
	SPARK3_PASSWORD: string;
	SPARK3_TAILSCALE_IP: string;
	PI_CLI_INSTALLED: string;
	TINES_API_KEY: string;
	NAS1_IP: string;
	NAS1_USER: string;
	NAS1_PASSWORD: string;
	NAS2_IP: string;
	NAS2_USER: string;
	NAS2_PASSWORD: string;
	GITHUB_PAT: string;
	GITHUB_PERSONAL_ACCESS_TOKEN: string;
	GITHUB_USER: string;
	NPM_TOKEN: string;
	NPM_TOKEN_READONLY: string;
	HEROKU_API_KEY: string;
	AWS_ACCESS_KEY_ID: string;
	AWS_SECRET_ACCESS_KEY: string;
	DD_SITE: string;
	DATADOG_KEY_ID: string;
	DATADOG_API_KEY: string;
	DATADOG_APP_KEY_ID: string;
	DATADOG_APP_API_KEY: string;
	COMPOSIO_ORG_TOKEN: string;
	COMPOSIO_PROJECT_NAME: string;
	COMPOSIO_PROJECT_ID: string;
	COMPOSIO_PROJECT_API_TOKEN: string;
	COMPOSIO_WEBHOOK_SECRET: string;
	BOTPRESS_WORKSPACE_ID: string;
	BOTPRESS_WORKSPACE_OWNER: string;
	SIM_AI_API_KEY: string;
	APIFY_API_KEY: string;
	SMITHERY_API_KEY: string;
	HOTGLUE_API_KEY: string;
	STRIPE_SECRET_KEY_1: string;
	STRIPE_RESTRICTED_KEY_1: string;
	STRIPE_SECRET_KEY_2: string;
	STRIPE_PUBLISHABLE_KEY_2: string;
	GUMROAD_ORDER_ID: string;
	GUMROAD_APP_SECRET: string;
	GUMROAD_APP_ID: string;
	GUMROAD_ACCESS_TOKEN: string;
	GUMROAD_LICENSE_KEY: string;
	COINBASE_PROJECT_ID: string;
	COINBASE_CLIENT_API_KEY: string;
	COINBASE_CDP_API_KEY_ID: string;
	COINBASE_API_KEY_ID_2: string;
	COINBASE_SECRET_2: string;
	COUCHBASE_CONNECTION_STRING: string;
	NHOST_ADMIN_SECRET: string;
	NHOST_SUBDOMAIN: string;
	NHOST_REGION: string;
	NHOST_HASURA_URL: string;
	NHOST_AUTH_URL: string;
	NHOST_GRAPHQL_URL: string;
	NHOST_STORAGE_URL: string;
	NHOST_FUNCTIONS_URL: string;
	AZURE_DATABRICKS_URL: string;
	AZURE_DATABRICKS_WORKSPACE_ID: string;
	AZURE_DATABRICKS_SUBSCRIPTION_ID: string;
	AZURE_DATABRICKS_API_TOKEN: string;
	AZURE_FOUNDRY_ENDPOINT: string;
	AZURE_FOUNDRY_REGION: string;
	WIX_ACCOUNT_ID: string;
	WIX_API_KEY: string;
	PAYLOAD_CMS_JWT: string;
	GAMMA_API_KEY: string;
	DIFY_APP_ID: string;
	N8N_API_KEY: string;
	UNSTRUCTURED_API_KEY: string;
	UNSTRUCTURED_PARTITION_URL: string;
	UNSTRUCTURED_WORKFLOW_URL: string;
	SERP_API_KEY: string;
	AHREFS_API_KEY: string;
	TELEGRAM_BOT_TOKEN_TEST: string;
	TELEGRAM_BOT_TOKEN_OPENWORK: string;
	VITE_REGION: string;
	VITE_PROJECT: string;
	VITE_AGENT_ID: string;
	LOOP_ACCOUNT: string;
	SEGMIND_API_KEY: string;
	VIDEO_JUNGLE_API_KEY: string;
	DEEPGRAM_API_KEY: string;
	MURF_API_KEY: string;
	HOSTINGER_API_KEY: string;
	KIMI_K2_API_KEY: string;
	GLASP_API_KEY: string;
	AMP_API_KEY: string;
	FALAI_API_KEY: string;
	RUNPOD_API_KEY: string;
	GAFFA_API_KEY: string;
	GOOGLE_API_KEY: string;
	APPWRITE_DEV_KEY: string;
	BUDIBASE_API_KEY: string;
	BUDIBASE_WEBHOOK_URL: string;
