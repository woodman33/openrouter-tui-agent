# TIMMY Brand Architecture

This document defines the official product branding and structural taxonomy for the **TIMMY** platform ecosystem.
...
### TIMMY
The ultimate governing brain, client interface, and orchestration standard for adaptive autonomous agent teams.

---

## Sub-Brands Taxonomy

| Sub-Brand Name | Focus Area | Technical Definition & Role |
| :--- | :--- | :--- |
...
| **RMUX Evidence** | Terminal Capture | Active terminal pane capture capture service producing visible proof screenshots and logs of running sessions. |
| **Context Packs** | Knowledge & Memory | Verified documentation packs, system manuals, and long-term memory bundles delivered to swarms. |
| **TIMMY Embassy** | Receipts Distribution | Cloudflare-hosted portal for securely distributing execution receipts and context packs to external agents. |
| **TIMMY Foundry** | Context Refinery | DGX/NAS context refinery, execution replay generators, and regression analysis testing benches. |
