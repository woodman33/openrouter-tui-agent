...
| p4.capsule | f4 | blocked | 0/2 | ✗ one Defold lane screenshot → detect → annotations on the board<br>✗ receipt evidence lists the detection result hash |
...
| 4 · Observer evidence (Roboflow) | blocked | 1/1 |
| 5 · Slate 3D | done | 2/2 |
| 6 · Sparks judge mesh (fleet rank) | next | 0/0 |

computed 2026-09-06T22:53:51.441Z from 915 root receipts · edge head 2026-09-06 11a3badebe07
